...
### <a name=partv> Partial Virtualization ( Ảo hóa một phần )
...
Có hai dạng Hypervisor:
  ...
  <ul>
  <li>Bare-Metal Hypervisor: Hypervisor tương tác trực tiếp với phần cứng của máy chủ để quản lý, phân phối và cấp phát tài nguyên.
