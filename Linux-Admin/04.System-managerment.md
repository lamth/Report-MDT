...
## 2.free
`free` là lệnh để hiển thị một số thông tin trong /proc/meminfo ở dạng có dễ đọc hơn. Ví dụ thêm tùy chọn -m để đọc các thông số ở dạng MB.
```
root@m4700:~# free -m
...
- **total**: là tổng số lượng của Ram/swap trên hệ thống