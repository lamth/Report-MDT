...
#### 2.4.4. Xóa brick, node, volume với replicated volume.
- Với Replicated Volume thì khi xóa brick cần cấu hình lại số replicate của volume tương ứng với số brick còn lại.
